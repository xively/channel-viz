(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'pgIjyQIP8YpeEEmYpWyjM4KVjbGk7o2cONXqBerknVH8fzZP', // Unique master Xively API key to be used as a default
		defaultFeeds	= [767902846], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'DS18B20', // Replaces Xively logo in the header
		...
		dataColor		= 'green', // CSS HEX value of color to represent data (omit leading #)
