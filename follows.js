(function ( $ ){
	...
	*/
	...
	var defaultKey		= 'READ-ONLY', // Unique master Xively API key to be used as a default
		defaultFeeds	= [1,2,3,4], // Comma separated array of Xively Feed ID numbers
		applicationName	= 'Monitorização de cubas de vinho', // Replaces Xively logo in the header
